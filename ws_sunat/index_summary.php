...
switch ($_GET['cod_6']) {
    case 1:
        ...
        break;
    case 2: //SE ENVIA 2 DESDE POSTMAN
        $ruta = '../files/facturacion_electronica/SUMMARY/FIRMA/';
        $metodo = 'sendSummary';    //enviar anulación
        break;
    case 3:
        $ruta = '../files/facturacion_electronica/SUMMARY/RPTA/';
...
//CREACIO DEL ZIP EN BASE AL ARCHIVO XML FIRMADO
