...
//    public $CustomizationID = "2.0";        
    ...
    //modalidad traslado
    public function catalogo_18($codigo){
        $motivo = '';
        switch ($codigo) {
            case "01":
                $motivo = 'Público';
    ...
    public function catalogo_20($codigo){
        ...
        switch ($codigo) {
            ...
            case "02":
                ...
                break;
            case "03":
                $motivo = 'Venta con entrega a terceros';
                break;
            case "04":
            ...
            case "06":
                ...
                break;
            case "07":
                $motivo = 'Recojo de bienes transformados';
                break;
            case "08":
                $motivo = 'Importación';
                break;
            ...
            case "14":
                ...
                break;
            case "17":
                $motivo = 'Traslado de bienes para transformación';
                break;
            case "18":
                $motivo = 'Traslado emisor itinerante CP';
                break;
            default:
    ...
    public function tipo_documentos($codigo){
        $motivo = '';
        switch ($codigo) {
            case "01":
                $motivo = 'Factura';
            ...
            case "08":
                ...
                break;
            case "09":
                $motivo = 'Guía de Remisión Remitente';
                break;
            case "31":
                $motivo = 'Guía de Remisión Transportista';
                break;
        }
        return $motivo;
    }
