...
$venta['total_exonerada']   = isset($venta['total_exonerada'])      ? $venta['total_exonerada']     : '0';
$venta['total_inafecta']    = isset($venta['total_inafecta'])       ? $venta['total_inafecta']      : '0';
...
$venta['vendedor']          = isset($venta['vendedor'])             ? $venta['vendedor']            : 'Panchito';
$venta['igv1']          	= isset($venta['igv1'])             	? $venta['igv1']            	: 0.18;
$venta['igv2']          	= isset($venta['igv2'])             	? $venta['igv2']            	: 1.18;
$venta['igv3']          	= isset($venta['igv3'])             	? $venta['igv3']            	: '18';
...
function crear_pdf($empresa, $cliente, $venta, $detalle, $nombre, $cuotas, $guias_adjuntas){
    ...
    $pdf->Cell(74,7,"Vendedor: ".$venta['vendedor'] ,0,0,'L');
    $pdf->Ln(8);
    ...
    foreach ($detalle as $values){            
        ...
        if ($values['tipo_igv_codigo'] == '10'){
            ...
            $pdf->Cell(30,10,number_format($values['precio_base'],2),0,0,'R');
            $pdf->Cell(30,10,number_format(($values['cantidad']*($values['precio_base'])), 2),0,0,'R');
        }
        $pdf->Ln(5);
    }
